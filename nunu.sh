...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[46m              ZYREX VPN STORE \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sanzstore21/sc/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sanzstore21/sc/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/sanzstore21/sc/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sanzstore21/sc/main/"
    wget https://raw.githubusercontent.com/sanzstore21/sc/main/files/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh
####
start=$(date +%s)
secs_to_human() {
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/sanzstore21/sc/main/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/sanzstore21/sc/main/REGIST | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/sanzsanzstore21/sc/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
